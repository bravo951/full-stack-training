...
namespace Infrastructure.Migrations
{
    public partial class Reset : Migration
    {
        ...
        {
            migrationBuilder.RenameColumn("User", "LastLoginDateTme", "LastLoginDateTime","dbo");
        ...
        //        constraints: table =>
        //        {
        //            table.PrimaryKey("PK_MovieCast", x => new { x.Character, x.MovieId, x.CastId });
        //            table.ForeignKey(
        ...
        //        constraints: table =>
        //        {
        //            table.PrimaryKey("PK_MovieCrew", x => new { x.Department, x.Job, x.MovieId, x.CrewId });
        //            table.ForeignKey(
        ...
        //            MovieId = table.Column<int>(type: "int", maxLength: 2084, nullable: false)
        //        },
        //        constraints: table =>
        //        {
        ...
        //        constraints: table =>
        //        {
        //            table.PrimaryKey("PK_Favotite", x => x.Id);
        //            table.ForeignKey(
        //                name: "FK_Favotite_Movie_MovieId",
        //                column: x => x.MovieId,
        //                principalTable: "Movie",
        //                principalColumn: "Id",
        //                onDelete: ReferentialAction.Cascade);
        //            table.ForeignKey(
        //                name: "FK_Favotite_User_MovieId",
        //                column: x => x.MovieId,
        //                principalTable: "User",
        //                principalColumn: "Id",
        //                onDelete: ReferentialAction.Cascade);
